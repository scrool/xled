...
class TestControlInterface(unittest.TestCase):
    ...
    def test_misc_info(self):
        ...
        self.assertEqual(res, {'strings': [{'first_led_id': 0, 'length': 125}, {'first_led_id': 125, 'length': 125}], 'code': 1000})
        #print(res)
    ...
    def test_timer(self):
        ...
        self.assertEqual(res, {'time_now': 68181, 'time_on': 3600, 'time_off': 7200, 'code': 1000})
        #print(res)
    ...
    def test_mqtt(self):
        ...
        self.assertEqual(res, {'broker_host': '127.0.0.1', 'broker_port': 8883, 'client_id': '840D8ED64F59', 'user': 'twinkly32', 'keep_alive_interval': 7200, 'code': 1000})
        #print(res)

        res = ctr.set_mqtt_config(res['broker_host'], res['broker_port'], res['client_id'], res['user'], res['keep_alive_interval'])._data
        self.assertEqual(res, {'code': 1000})
        #print(res)
    ...
    def test_effect(self):
        ...
        self.assertEqual(res, {'preset_id': 2, 'unique_id': '00000000-0000-0000-0000-000000000003', 'code': 1000})
        #print(res)

    # Available from fw version 2.4.2
    @vcr.use_cassette("tests/cassettes/TestControlInterface.test_brightness_saturation.yaml")
    ...
    def test_movie_oldif(self):
        ...
        self.assertEqual(res, {'frame_delay': 50, 'leds_number': 250, 'loop_type': 0, 'frames_number': 120, 'sync': {'mode': 'none', 'compat_mode': 0}, 'code': 1000})
        #print(res)
        ...
        res = ctr.get_mode()._data
        self.assertEqual(res, {'mode': 'movie', 'shop_mode': 0, 'id': 0, 'unique_id': 'A151A936-2836-4BB2-926C-BE592052D60E', 'name': '', 'code': 1000})
        #print(res)
    ...
    def test_movie_newif(self):
        ...
        self.assertEqual(res, {'movies': [], 'available_frames': 992, 'max_capacity': 992, 'code': 1000})
        #print(res)

        res = ctr.set_movies_new("green", "00000000-0000-0000-000A-000000000001", "rgb_raw", numleds, 1, 1)._data
        self.assertEqual(res, {'entry_point': 0, 'id': 0, 'handle': 15, 'unique_id': '00000000-0000-0000-000A-000000000001', 'code': 1000})
        #print(res)
        ...
        res = ctr.set_movies_new("lime", "00000000-0000-0000-000A-000000000002", "rgb_raw", numleds, 1, 1)._data
        self.assertEqual(res, {'entry_point': 2, 'id': 1, 'handle': 16, 'unique_id': '00000000-0000-0000-000A-000000000002', 'code': 1000})
        #print(res)
        ...
        self.assertEqual(res, {'id': 1, 'unique_id': '00000000-0000-0000-000A-000000000002', 'name': 'lime', 'code': 1000})
        #print(res)
    ...
    def test_playlist(self):
        ...
        self.assertEqual(res, {'unique_id': '00000000-0000-0000-0000-000000000000', 'name': '', 'entries': [{'id': 0, 'handle': 15, 'name': 'green', 'unique_id': '00000000-0000-0000-000A-000000000001', 'duration': 5}, {'id': 1, 'handle': 16, 'name': 'lime', 'unique_id': '00000000-0000-0000-000A-000000000002', 'duration': 5}], 'code': 1000})
        #print(res)
        ...
        res = ctr.get_mode()._data
        self.assertEqual(res, {'mode': 'playlist', 'shop_mode': 0, 'movie': {'id': 0, 'unique_id': '00000000-0000-0000-000A-000000000001', 'name': 'green', 'duration': 5}, 'name': '', 'unique_id': '00000000-0000-0000-0000-000000000000', 'code': 1000})
        #print(res)

        res = ctr.get_playlist_current()._data
        self.assertEqual(res, {'duration': 5, 'id': 0, 'unique_id': '00000000-0000-0000-000A-000000000001', 'name': 'green', 'code': 1000})
        #print(res)
    ...
    def test_layout(self):
        ...
        res = ctr.set_led_layout(res['source'], res['coordinates'], res['synthesized'])._data
    ...
    def test_network_scan(self):
        ...
        self.assertEqual(res, {'code': 1000, 'networks': [{'ssid': 'TN_24GHz_D21CEF', 'mac': '30:91:8f:d2:1c:ef', 'rssi': 203, 'channel': 11, 'enc': 4}]})
        #print(res)
    ...
    def test_network_mode_ap(self):
        ...
        self.assertEqual(res, {'mode': 1, 'station': {'ssid': 'TN_24GHz_D21CEF', 'ip': '192.168.10.100', 'gw': '192.168.10.1', 'mask': '255.255.255.0', 'rssi': -60}, 'ap': {'ssid': 'Twinkly_D64F59', 'channel': 1, 'ip': '192.168.4.1', 'enc': 4, 'ssid_hidden': 0, 'max_connections': 4, 'password_changed': 1}, 'code': 1000})
        #print(res)
    ...
    @vcr.use_cassette("tests/cassettes/TestControlInterface.test_network_mode_station.yaml")
    def test_network_mode_station(self):
        ctr = ControlInterface("192.168.4.1")

        res = ctr.get_network_status()._data
        self.assertEqual(res, {'mode': 2, 'station': {'ssid': '', 'ip': '0.0.0.0', 'gw': '0.0.0.0', 'mask': '0.0.0.0'}, 'ap': {'ssid': 'Twinkly_D64F59', 'channel': 6, 'ip': '192.168.4.1', 'enc': 3, 'ssid_hidden': 0, 'max_connections': 4, 'password_changed': 1}, 'code': 1000})
        #print(res)
